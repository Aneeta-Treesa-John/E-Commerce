<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="Phase_1.Payment" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label3" runat="server" Text="Redirected to https://ayc.bankportal.gateway"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
